...
export function operationalScorecard(state) {
  ...
  const checks = [
    { id: "security_headers", label: "Baseline browser security headers installed", status: "passing", points: 25 },
    { id: "request_correlation", label: "Every request receives an x-request-id", status: "passing", points: 25 },
    {
      id: "runtime_counters",
